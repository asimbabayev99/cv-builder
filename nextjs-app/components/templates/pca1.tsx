...
export default function TemplatePca1() {
  return (
    <>
      ...
      .skn-pca1 .lowerborder{margin-top:2px;border-bottom:2px solid #1A4771}
      .skn-pca1 .name{letter-spacing:0.58px;font-weight:bold;background-color:#1D4871;padding-bottom:10px;font-family:'Roboto Condensed';text-transform:uppercase;text-align:center;color:#FFF}
      .skn-pca1 .resumeTitle{font-weight:900;background-color:#1D4871;text-align:center;color:#fff;text-transform:uppercase;letter-spacing:0.5px;padding-bottom:10px;margin-top:-2px}
      .skn-pca1 .paragraph{position:relative}
      .skn-pca1 .heading{clear:both;font-weight:bold}
      .skn-pca1 .address{position:relative;text-align:center;font-size:0.917em;line-height:1.25em;margin:0;color:#1A4771;padding-left:5px;padding-right:5px}
      ...
      .skn-pca1 .thinbottomborder{border-bottom:1px solid #1A4771}
      ...
      .skn-pca1 .lgtBg{position:relative;padding-bottom:8px}
	    .skn-pca1 .lgtBg:before{content:'';position:absolute;width:100%;height:100%;left:0;top:0px;opacity:.2;background-color: #1A4771;}
     ...
     .skn-pca1 .lang-sec,.skn-pca1 .skli-sec{display:flex;flex-wrap:wrap;justify-content:space-between}
      ...
      .skn-pca1 .inner-rating{background-color:#1A4771;height:4px;width:60%}
      ...
      .skn-pca1 .thinbottomborder,.skn-pca1 .lowerborder{border-color:#1A4771}
      ...
      .skn-pca1 .address{font-size:10px;line-height:12px;color:#1A4771}
      .skn-pca1 .address li:before{font-size:13px}
      .skn-pca1 .name{font-size:28px;line-height:30px;background-color:#1A4771}
      .skn-pca1 .resumeTitle{font-size:10px;line-height:12px;background-color:#1A4771}
      .skn-pca1 .lgtBg:before{background-color:#1A4771;opacity:.2}
      ...
      .skn-pca1 .totl-expr{background-color:#1A4771;font-size:8px;line-height:12px;padding:0 6px}
      ...
      .skn-pca1 .inner-rating{background-color:#1A4771}
  ...
  `}</style>
      <div className="svg-skin "><div data-testid="embd-98t1CZ7" className="" tabIndex={0}><div></div><div data-testid="embd-95CA90b" className="document doc-root doc-finalize fontsize fontface vmargins hmargins pgsz-a4 pagesize skn-pca1 PCA1 MUK pict-pcpf-purl texp-rectangle expr-durt-none " docskinwidth="545" ><div data-testid="embd-91y4rV2" className="name-contact "><div></div><div></div><div data-testid="embd-88MByq6-PRFL" id="SECTION_PRFL30868c37-6fcc-4b70-b87a-afd2447ce0d4" className="section section-prfl SECTION_PRFL firstsection" data-section-cd="PRFL"><div data-testid="embd-88uQIHR-PRFL" className="doc-item"><div data-testid="embd-88aw0Ce-PRFL" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-04f55583-5181-435c-8336-f48964adf912" id="PARAGRAPH_PRFL_04f55583-5181-435c-8336-f48964adf912" className="paragraph PARAGRAPH_PRFL firstparagraph"><div data-testid="embd-78KlmQp">
       ...
       <div className="lgtBg">
	    <div className="address btmgap">
          ...
          <span dependency="ADDR|STRT|CITY|STAT|ZIPC|NBHD|MSTA"><ul><li></li></ul></span>
          <span id="FIELD_REMW"></span>
          
          <span className="dispInBlk maxWidth">
          <span id="FIELD_HPHN">07912 345 678</span></span>
          <span dependency="HPHN+CPHN|EMAI"><ul><li></li></ul></span>
          <span className="dispInBlk maxWidth">
      ...
      </div></div></div></div></div></div></div><div data-testid="embd-89XOkPJ0" className="parent-wrapper"><div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="45" className="sortable-item section-container SortableItem-sibling"><div data-testid="embd-88MByq6-SUMM" id="SECTION_SUMMaae374b0-0228-4808-a3fe-b04cc0c571fb" className="section SECTION_SUMM has-title" data-section-cd="SUMM"><div data-testid="embd-88uQIHR-SUMM" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_SUMM">PROFESSIONAL SUMMARY<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename PROFESSIONAL SUMMARY " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-SUMM" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-f6669442-f38f-e0e2-fad7-6104f95f3e6d" id="PARAGRAPH_SUMM_f6669442-f38f-e0e2-fad7-6104f95f3e6d" className="paragraph PARAGRAPH_SUMM firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
  ...
  <li>Supervised frequent activities such as medication and personal hygiene to provide safe living environment htmlFor patients.</li></ul></span>
      ...
      </div></div></div></div></div></div></div><button data-testid="embd-900sYS3" type="button" className="btn-icon-tertiary btn-icon-move d-none" style={{ right: '-114px' }}><i data-testid="embd-90rd2E3" tabIndex={0} data-react-beautiful-dnd-drag-handle="45" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="icon-move" title="Move"></i></button></div><div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="45" className="sortable-item section-container SortableItem-sibling"><div data-testid="embd-88MByq6-HILT" id="SECTION_HILT66551e16-9025-4c6a-88fd-21c891f7b2b4" className="section SECTION_HILT has-title" data-section-cd="HILT"><div data-testid="embd-88uQIHR-HILT" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_HILT">SKILLS<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename SKILLS " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-HILT" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-f6d39a0e-45b4-431c-82b8-567b069b1da4" id="PARAGRAPH_HILT_f6d39a0e-45b4-431c-82b8-567b069b1da4" className="paragraph PARAGRAPH_HILT firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
