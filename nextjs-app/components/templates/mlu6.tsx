...
export default function TemplateMlu6() {
  return (
    <>
      <style>{`
        ...
        .skn-mlu6 .right-box{background-color:#2b2b2b;display:table-cell;overflow:hidden;background-size:100%;color:#fff;padding:25px}
        .skn-mlu6 .right-box .section{padding-left:10px;padding-right:10px}
        .skn-mlu6 .right-box .section:not(:empty){border-bottom:1px solid #9b9b9b}
        ...
        .skn-mlu6 .left-box .heading{letter-spacing:0}
        ...
        .skn-mlu6 .right-box .ratingBar:before{content:'';width:100%;height:4px;position:absolute;z-index:1;opacity:.5}
        ...
        /* Duration tag */
        .skn-mlu6 .totl-expr{display:inline-block;float:right; padding:0 6px;color:#fff;font-weight:700;vertical-align:top;text-wrap:nowrap;margin-left:5px}
        ...
        .skn-mlu6 .address2{font-size:11px;line-height:{$CILH}px}
        ...
        .skn-mlu6 .right-box{background-color:#4a4a4a}
        .skn-mlu6 .right-box .wrapper{background:#4a4a4a} /*For finalize page*/
        .skn-mlu6 .prflPic img{width:130px;height:168px}
		.skn-mlu6 .right-box > .sortable-item .section,
        .skn-mlu6 .right-box > .sortable-item .paragraph,.skn-mlu6 .left-box .innerRating,.skn-mlu6 .right-box .ratingBar:before{background:#4a4a4a} /*For finalize page*/
		.skn-mlu6 .totl-expr{background-color:#4a4a4a;font-size:8px;line-height:12px}
  ...
  <li>Administered all necessary medications as directed by care plan.</li></ul></span>
                    ...
                    </div></div></div><div data-testid="embd-87je894-EXPR" data-react-beautiful-dnd-draggable="24" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EXPR" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="24" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-5c57d155-aa5a-4a63-87f2-90490c80548b" id="PARAGRAPH_EXPR_5c57d155-aa5a-4a63-87f2-90490c80548b" className="paragraph PARAGRAPH_EXPR"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                        <div className="singlecolumn">
                            <span className="paddedline" dependency="JSTD|EDDT|TEXP">
                                <span className="dflex">
                                    <span>
                                        <span className="jobdates" id="FIELD_JSTD" format="%m/%Y">09/2010</span><span dependency="JSTD+EDDT"> - </span>
  ...
  <li>Worked to improve patient outlook and daily living through compassionate care.</li></ul></span>
                        ...
                        <div className="singlecolumn">
                            <span className="paddedline" dependency="JSTD|EDDT|TEXP">
                                <span className="dflex">
                                    <span>
                                        <span className="jobdates" id="FIELD_JSTD" format="%m/%Y">11/2008</span><span dependency="JSTD+EDDT"> - </span>
                            ...
                            <span className="paddedline locationGap" dependency="COMP|JSTA|JCIT|JCNT">
                                <span className="companyname txtBold" id="FIELD_COMP">Four Seasons Health Care</span><span dependency="COMP"><span dependency="JCIT|JSTA|JCNT"> | </span></span>
                                <span className="jobcity" id="FIELD_JCIT">Edinburgh</span>
                                <span className="jobstate" id="FIELD_JSTA"></span> <span className="joblocation jobcountry" id="FIELD_JCNT"></span>
                            </span>
                            <span className="paddedline" dependency="JTIT">
