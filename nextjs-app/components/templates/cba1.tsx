                  ...
                  <div data-testid="embd-654vWVD6" className="">
                    <div data-testid="embd-79HRa2m-04f55583-5181-435c-8336-f48964adf912"
                      ...
                      <div data-testid="embd-78KlmQp">
                        <div className="name">
                          <span id="FIELD_FNAM" data-uppercase="true">Dom</span>
                          <span dependency="FNAM+LNAM"></span>
                          <span id="FIELD_LNAM" data-uppercase="true">Webster</span>
                        </div>
            ...
            <div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="27"
              ...
              <div data-testid="embd-88MByq6-SUMM" id="SECTION_SUMMaae374b0-0228-4808-a3fe-b04cc0c571fb"
                ...
                style={{ right: '-114px' }}><i data-testid="embd-90rd2E3" tabIndex={0}
                  data-react-beautiful-dnd-drag-handle="27"
                ...
                <div data-testid="embd-88uQIHR-EXPR" className="doc-item">
                  ...
                  <div data-testid="embd-88aw0Ce-EXPR" className="">
                    <div data-testid="embd-87S8HNi313e1c77-349e-497b-bdb6-f0271f1e85bf"
                      ...
                      <div data-testid="embd-87je894-EXPR" data-react-beautiful-dnd-draggable="27"
                          ...
                          <div data-testid="embd-78FzR29" className="clearfix doc-item">
                            <div className="singlecolumn">
                              <span className="paddedline" dependency="JTIT|JSTD|EDDT|TEXP">
                                <span className="jobtitle" id="FIELD_JTIT">Senior Care Assistant</span><span
                              ...
                              <span className="paddedline" dependency="COMP|JSTA|JCIT|JCNT|JCTR">
                                <span className="companyname" id="FIELD_COMP">Private Care Home</span><span
                                  dependency="COMP"><span dependency="JCIT|JSTA|JCNT|JCTR"> - </span></span>
                                <span className="joblocation jobcity" id="FIELD_JCIT">Edinburgh</span><span
                              ...
                              <span className="jobline" id="FIELD_JDES">
                                <ul>
                                  <li>Met with patients and families to discuss care and plan of action htmlFor future.</li>
                                  <li>Implemented new team onboarding programme, reducing training time from four weeks
                                    to two.</li>
                      ...
                      <div data-testid="embd-87je894-EXPR" data-react-beautiful-dnd-draggable="27"
                        ...
                        <div data-testid="embd-79HRa2m-5c57d155-aa5a-4a63-87f2-90490c80548b"
                          ...
                          <div data-testid="embd-78FzR29" className="clearfix doc-item">
                            <div className="singlecolumn">
                              <span className="paddedline" dependency="JTIT|JSTD|EDDT|TEXP">
                                <span className="jobtitle" id="FIELD_JTIT">Care Assistant</span><span
                                  dependency="JTIT"><span dependency="JSTD|EDDT">,</span></span>
                              ...
                              <span className="paddedline" dependency="COMP|JSTA|JCIT|JCNT|JCTR">
                                <span className="companyname" id="FIELD_COMP">Ideal Care Homes</span><span
                                  dependency="COMP"><span dependency="JCIT|JSTA|JCNT|JCTR"> - </span></span>
                                <span className="joblocation jobcity" id="FIELD_JCIT">Edinburgh</span><span
                                  dependency="JCIT"></span><span className="joblocation jobstate"
                                  id="FIELD_JSTA"></span><span className="joblocation jobcountry"
                        ...
                        <div data-testid="embd-79HRa2m-5c57d155-aa5a-4a63-87f2-90490c80548b"
                          ...
                          <div data-testid="embd-78FzR29" className="clearfix doc-item">
                            <div className="singlecolumn">
                              ...
                              <span className="paddedline" dependency="COMP|JSTA|JCIT|JCNT|JCTR">
                                <span className="companyname" id="FIELD_COMP">Four Seasons Health Care</span><span
                                  dependency="COMP"><span dependency="JCIT|JSTA|JCNT|JCTR"> - </span></span>
                                <span className="joblocation jobcity" id="FIELD_JCIT">Edinburgh</span><span
                                  dependency="JCIT"></span><span className="joblocation jobstate"
                                  id="FIELD_JSTA"></span><span className="joblocation jobcountry"
                              ...
                              <span className="jobline" id="FIELD_JDES">
                                <ul>
                                  ...
                                  <li>Supervised frequent activities such as medication and personal hygiene to provide
                                    safe living environment htmlFor patients.</li>
                                </ul>
                              </span>
                            </div>
                          </div>
                ...
                <div data-testid="embd-88uQIHR-EDUC" className="doc-item">
                  ...
                  <div data-testid="embd-88aw0Ce-EDUC" className="">
                    <div data-testid="embd-87S8HNifd38dd6c-e289-4f1b-96e2-457086a24cc8"
                      ...
                      <div data-testid="embd-87je894-EDUC" data-react-beautiful-dnd-draggable="27"
                        className="sortable-item paragraph-container SortableItem-sibling"><button
                            ...
                            <div className="singlecolumn">
                              <span className="paddedline" dependency="GRYR|STUY|DGRE|GRST|GRED|GRIP">
                                <span className="degree" id="FIELD_DGRE">NVQ Level 3</span><span
                                  ...
                                  Care</span><span dependency="DGRE|STUY"><span dependency="GRYR|GRST|GRED">,
                                  </span></span>
                              ...
                              <span className="paddedline" dependency="SCIT|SCHO|SSTA|SCNT|GRHN">
                                <span className="companyname companyname_educ" id="FIELD_SCHO">Edinburgh College</span><span
                                  dependency="SCHO"><span dependency="SCIT|SSTA|SCNT"> - </span></span><span
                                  className="joblocation jobcity" id="FIELD_SCIT">Edinburgh</span><span
                                  dependency="SCIT"></span><span className="joblocation jobstate"
                                  id="FIELD_SSTA"></span><span className="joblocation jobcountry"
                                  id="FIELD_SCNT"></span><span dependency="SCIT|SCHO|SSTA|SCNT"></span><span
                                  id="FIELD_GRHN"></span>
                              </span>
