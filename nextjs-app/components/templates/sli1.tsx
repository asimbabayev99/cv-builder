...
export default function TemplateSli1() {
  return (
    <>
      <style>{`
        ...
        .skn-sli1 .SECTION_NAME,.skn-sli1 .SECTION_CNTC{margin:0;padding:0 30px;background:#434d54;border:1px solid #434d54;clear:inherit;overflow:inherit;margin-left:0;margin-right:0}
        ...
        /* .skn-sli1 .lang-sec.infobarsec .paragraph:before{display:none} */
        ...
        .skn-sli1 .sliced-rect .sliced-rect-tile.ratvfill{background-color:#009bcc}
        ...
        .skn-sli1 .section{border-color:#009bcc;margin-top:25px}
        .skn-sli1 .skli-sec{margin-bottom:25px}
        .skn-sli1 .SECTION_NAME,.skn-sli1 .SECTION_CNTC{margin-top:0!important;background:#009bcc;border-color:#009bcc}
        .skn-sli1 .SECTION_NAME{padding-top:42px!important}
        .skn-sli1 .heading{color:#009bcc}
        ...
        .skn-sli1 .totl-expr{background-color:#009bcc;font-size:8px;line-height:12px}

        /*Infographic*/
        .skn-sli1 .lang-sec.infobarsec .inner-rating,.skn-sli1 .skli-sec.infobarsec .inner-rating{background-color:#009bcc}
        .skn-sli1 .lang-sec.infobarsec{padding-left:133px}
        .skn-sli1 .lang-sec.infobarsec .heading{margin-left:-133px}
        /* .skn-sli1 .lang-sec,.skn-sli1 .skli-sec{padding-left:0px} */
        ...
        /*Rectangular Rating Blocks*/
        .skn-sli1 .paragraph .sliced-rect .sliced-rect-tile.ratvfill{background-color:#009bcc}
        ...
        .skn-sli1.MUK .sortable-item.name-contact + div .sortable-item:first-child .section{border-top:2px solid #009bcc}
    ...
    `}</style>
      <div className="svg-skin "><div data-testid="embd-98t1CZ7" className="" tabIndex={0}><div></div><div data-testid="embd-95CA90b" className="document doc-root doc-finalize fontsize fontface vmargins hmargins pagesize skn-sli1 SLI1 MUK pgsz-a4 texp-none pict-pcpf-purl " docskinwidth="598" ><div data-testid="embd-91y4rV2" className="name-contact "><div data-testid="embd-88MByq6-NAME" id="SECTION_NAME1a1a32ad-f01c-4377-b2f6-1a65f9bf6cb8" className="section SECTION_NAME inHeader firstsection" data-section-cd="NAME"><div data-testid="embd-88uQIHR-NAME" className="doc-item"><div data-testid="embd-88aw0Ce-NAME" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-44bc0bd4-6d0c-480d-8f32-8d70df1621d0" id="PARAGRAPH_NAME_44bc0bd4-6d0c-480d-8f32-8d70df1621d0" className="paragraph PARAGRAPH_NAME firstparagraph"><div data-testid="embd-78blCsH">
                <div className="name">
            ...
            </div></div></div></div></div></div><div data-testid="embd-88MByq6-CNTC" id="SECTION_CNTCd3d40c22-1b29-401e-a809-9cb7e72d6fdc" className="section SECTION_CNTC inHeader pt-20" data-section-cd="CNTC"><div data-testid="embd-88uQIHR-CNTC" className="doc-item"><div data-testid="embd-88aw0Ce-CNTC" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-3912838f-29f6-467c-8297-bf45ee1ff720" id="PARAGRAPH_CNTC_3912838f-29f6-467c-8297-bf45ee1ff720" className="paragraph PARAGRAPH_CNTC firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                <span className="address">
                    <span className="fieldWrapper" dependency="ADDR|STRT|CITY|STAT|ZIPC">
                        <span id="FIELD_STRT">46 Roman Rd</span><span dependency="STRT"><span dependency="CITY|STAT">, </span></span><span className="spaced" id="FIELD_CITY">Leeds</span><span className="spaced" id="FIELD_STAT"></span> <span className="spaced" id="FIELD_ZIPC">LS2 3ZR</span>
                        <span id="FIELD_ADDR"></span>
                    </span>
                    
                    <span className="fieldWrapper" dependency="HPHN|CPHN"><span id="FIELD_HPHN">07912 345 678</span><span id="FIELD_CPHN"></span></span>
                    <span className="fieldWrapper" dependency="EMAI"><span id="FIELD_EMAI">dom.webster@example.co.uk</span></span>
            ...
            </div></div></div></div></div></div><div></div></div><div data-testid="embd-89XOkPJ0" className="parent-wrapper"><div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="25" className="sortable-item section-container SortableItem-sibling"><div data-testid="embd-88MByq6-SUMM" id="SECTION_SUMMaae374b0-0228-4808-a3fe-b04cc0c571fb" className="section summary SECTION_SUMM has-title" data-section-cd="SUMM"><div data-testid="embd-88uQIHR-SUMM" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_SUMM">PROFESSIONAL SUMMARY<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename PROFESSIONAL SUMMARY " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-SUMM" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-f6669442-f38f-e0e2-fad7-6104f95f3e6d" id="PARAGRAPH_SUMM_f6669442-f38f-e0e2-fad7-6104f95f3e6d" className="paragraph PARAGRAPH_SUMM firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                ...
                <div className="singlecolumn">
                    ...
                    <span className="paddedline locationGap " dependency="COMP|JSTA|JCIT|JCNT|JLOC">
                        ...
                        <span className="jobstate" id="FIELD_JSTA"></span><span className="joblocation jobcountry" id="FIELD_JCNT"></span><span id="FIELD_JLOC"></span>
                    </span>
  ...
  <li>Supervised frequent activities such as medication and personal hygiene to provide safe living environment htmlFor patients.</li></ul></span>
            ...
            </div></div></div></div></div></div></div><button data-testid="embd-900sYS3" type="button" className="btn-icon-tertiary btn-icon-move d-none" style={{ right: '-114px' }}><i data-testid="embd-90rd2E3" tabIndex={0} data-react-beautiful-dnd-drag-handle="25" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="icon-move" title="Move"></i></button></div><div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="25" className="sortable-item section-container SortableItem-sibling"><div data-testid="embd-88MByq6-HILT" id="SECTION_HILT66551e16-9025-4c6a-88fd-21c891f7b2b4" className="section SECTION_HILT has-title" data-section-cd="HILT"><div data-testid="embd-88uQIHR-HILT" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_HILT">SKILLS<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename SKILLS " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-HILT" className=""><div data-testid="embd-654vWVD6" className=""><div data-testid="embd-79HRa2m-f6d39a0e-45b4-431c-82b8-567b069b1da4" id="PARAGRAPH_HILT_f6d39a0e-45b4-431c-82b8-567b069b1da4" className="paragraph PARAGRAPH_HILT firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
  ...
  <li>Behaviour redirection</li></ul></div>
            ...
            </div></div></div></div></div></div><button data-testid="embd-900sYS3" type="button" className="btn-icon-tertiary btn-icon-move d-none" style={{ right: '-114px' }}><i data-testid="embd-90rd2E3" tabIndex={0} data-react-beautiful-dnd-drag-handle="25" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="icon-move" title="Move"></i></button></div><div data-testid="embd-89Z70JT" data-react-beautiful-dnd-draggable="25" className="sortable-item section-container SortableItem-sibling"><div data-testid="embd-88MByq6-EDUC" id="SECTION_EDUCfd38dd6c-e289-4f1b-96e2-457086a24cc8" className="section education SECTION_EDUC multi-para has-title" data-section-cd="EDUC"><div data-testid="embd-88uQIHR-EDUC" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_EDUC">EDUCATION<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename EDUCATION " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-EDUC" className=""><div data-testid="embd-87S8HNifd38dd6c-e289-4f1b-96e2-457086a24cc8" id="CONTAINER_fd38dd6c-e289-4f1b-96e2-457086a24cc8" className="sortableInner"><div data-testid="embd-87je894-EDUC" data-react-beautiful-dnd-draggable="25" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EDUC" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="25" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-e0037f47-0bb8-4767-a441-48042b09746f" id="PARAGRAPH_EDUC_e0037f47-0bb8-4767-a441-48042b09746f" className="paragraph PARAGRAPH_EDUC firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                <div className="singlecolumn">
                    <div className="paddedline" dependency="DGRE|STUY|GRYR|GRST|GRED|GRIP|GRHN">
                        <span className="degree txt-bold" id="FIELD_DGRE">NVQ Level 3</span><span className="mukcolon" dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP">: </span></span><span className="colon" dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP"> : </span></span>
                        <span className="programline" id="FIELD_STUY">Health And Social Care</span><span id="FIELD_GRHN"></span><span dependency="GRHN|STUY"><span dependency="GRYR|GRST|GRED|GRIP">,</span></span>
                    ...
                    <div className="paddedline degreeGap" dependency="STUY|GRPA">
                        <span id="FIELD_GRPA"></span>
                    </div>
                     
                    <span id="FIELD_FRFM"></span>
                </div>
            </div></div></div><div data-testid="embd-87je894-EDUC" data-react-beautiful-dnd-draggable="25" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EDUC" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="25" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-e0037f47-0bb8-4767-a441-48042b09746f" id="PARAGRAPH_EDUC_e0037f47-0bb8-4767-a441-48042b09746f" className="paragraph PARAGRAPH_EDUC"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                <div className="singlecolumn">
                    <div className="paddedline" dependency="DGRE|STUY|GRYR|GRST|GRED|GRIP|GRHN">
                        <span className="degree txt-bold" id="FIELD_DGRE">NVQ Level 2</span><span className="mukcolon" dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP">: </span></span><span className="colon" dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP"> : </span></span>
                        <span className="programline" id="FIELD_STUY">Health And Social Care</span><span id="FIELD_GRHN"></span><span dependency="GRHN|STUY"><span dependency="GRYR|GRST|GRED|GRIP">,</span></span>
                        <span dependency="GRST|GRED|GRIP|GRYR" className="jobdates">
