...
export default function TemplateMli3() {
  ...
  <li>Behaviour redirection</li></ul></span>
                        ...
                        <div className="singlecolumn">
                            ...
                            <span className="dispBlock pb5 compfont locationGap" dependency="COMP|JSTA|JCIT|JCNT">
                                <span className="companyname txtBold txtItl" id="FIELD_COMP">Private Care Home</span><span dependency="COMP"><span dependency="JSTA|JCIT|JCNT"> - </span></span><span className="jobcity" id="FIELD_JCIT">Edinburgh</span>
  ...
  <li>Administered all necessary medications as directed by care plan.</li></ul></span>
                    ...
                    </div></div></div><div data-testid="embd-87je894-EXPR" data-react-beautiful-dnd-draggable="35" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EXPR" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="35" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-5c57d155-aa5a-4a63-87f2-90490c80548b" id="PARAGRAPH_EXPR_5c57d155-aa5a-4a63-87f2-90490c80548b" className="paragraph PARAGRAPH_EXPR"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                        <div className="singlecolumn">
                            <span className="dispBlock pb5 compfont" dependency="JTIT|JSTD|EDDT">
                                <span className="dflex">
                                    <span>
                                        <span className="jobtitle txtCaps txtBold" id="FIELD_JTIT">Care Assistant</span><span className="txtBold" dependency="JTIT+JSTD|EDDT">, </span>
                            ...
                            <span className="dispBlock pb5 compfont locationGap" dependency="COMP|JSTA|JCIT|JCNT">
                                <span className="companyname txtBold txtItl" id="FIELD_COMP">Ideal Care Homes</span><span dependency="COMP"><span dependency="JSTA|JCIT|JCNT"> - </span></span><span className="jobcity" id="FIELD_JCIT">Edinburgh</span>
                                <span className="jobstate" id="FIELD_JSTA"></span><span className="joblocation jobcountry" id="FIELD_JCNT"></span>
                            </span>
  ...
  <li>Worked to improve patient outlook and daily living through compassionate care.</li></ul></span>
                        ...
                        <div className="singlecolumn">
                            ...
                            <span className="dispBlock pb5 compfont locationGap" dependency="COMP|JSTA|JCIT|JCNT">
                                <span className="companyname txtBold txtItl" id="FIELD_COMP">Four Seasons Health Care</span><span dependency="COMP"><span dependency="JSTA|JCIT|JCNT"> - </span></span><span className="jobcity" id="FIELD_JCIT">Edinburgh</span>
                                <span className="jobstate" id="FIELD_JSTA"></span><span className="joblocation jobcountry" id="FIELD_JCNT"></span>
                            </span>
  ...
  <li>Supervised frequent activities such as medication and personal hygiene to provide safe living environment htmlFor patients.</li></ul></span>
                    ...
                    </div></div></div></div></div></div></div></div><div data-testid="embd-94h2gQ2" data-react-beautiful-dnd-draggable="35" className="sortable-item section-container SortableItem-sibling  data-EDUC"><div data-testid="embd-94w3bZE" className="document-tool sec-tool" id="editIcons" style={{ right: '-2px' }}></div><div data-testid="embd-88MByq6-EDUC" id="SECTION_EDUCfd38dd6c-e289-4f1b-96e2-457086a24cc8" className="section SECTION_EDUC multi-para has-title" data-section-cd="EDUC"><div data-testid="embd-88uQIHR-EDUC" className="doc-item"><div data-testid="embd-88ciQTv" className="heading"><div data-testid="embd-88NTvWF" className="sectiontitle" id="SECTIONNAME_EDUC">EDUCATION<span data-testid="embd-88kl0Xw-text_1tUe18" title="Rename EDUCATION " className="ds-link ds-link-default rename-section text-rename"></span></div></div><div data-testid="embd-88aw0Ce-EDUC" className=""><div data-testid="embd-87S8HNifd38dd6c-e289-4f1b-96e2-457086a24cc8" id="CONTAINER_fd38dd6c-e289-4f1b-96e2-457086a24cc8" className="sortableInner"><div data-testid="embd-87je894-EDUC" data-react-beautiful-dnd-draggable="35" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EDUC" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="35" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-e0037f47-0bb8-4767-a441-48042b09746f" id="PARAGRAPH_EDUC_e0037f47-0bb8-4767-a441-48042b09746f" className="paragraph PARAGRAPH_EDUC firstparagraph"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                        <div className="singlecolumn">
                            <div>
                                <span className="dispBlock pb5 compfont" dependency="DGRE|STUY|GRYR|GRST|GRED|GRIP">
                                    <span className="degree txtBold" id="FIELD_DGRE">NVQ Level 3</span><span dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP"><span className="mukcolon">: </span><span className="colon"> : </span></span></span>
                                    <span className="programline" id="FIELD_STUY">Health And Social Care</span><span className="jobdates" id="FIELD_GRHN"></span><span dependency="GRHN|STUY"><span dependency="GRYR|GRST|GRED|GRIP">,</span></span>
                                ...
                                <span className="dispBlock pb5 compfont" dependency="SCHO|SCIT|SSTA|SCNT">
                                    <span className="companyname txtBold txtItl" id="FIELD_SCHO">Edinburgh College</span><span dependency="SCHO"><span dependency="SCIT|SSTA|SCNT"> - </span></span>
                    ...
                    </div></div></div><div data-testid="embd-87je894-EDUC" data-react-beautiful-dnd-draggable="35" className="sortable-item paragraph-container SortableItem-sibling"><button data-testid="embd-87gfxIF-EDUC" type="button" tabIndex={0} data-react-beautiful-dnd-drag-handle="35" aria-roledescription="Draggable item. Press space bar to lift" draggable={false} className="btn-icon-tertiary btn-icon-move d-none"></button><div data-testid="embd-79HRa2m-e0037f47-0bb8-4767-a441-48042b09746f" id="PARAGRAPH_EDUC_e0037f47-0bb8-4767-a441-48042b09746f" className="paragraph PARAGRAPH_EDUC"><div data-testid="embd-78FzR29" className="clearfix doc-item">
                        <div className="singlecolumn">
                            <div>
                                <span className="dispBlock pb5 compfont" dependency="DGRE|STUY|GRYR|GRST|GRED|GRIP">
                                    <span className="degree txtBold" id="FIELD_DGRE">NVQ Level 2</span><span dependency="DGRE"><span dependency="STUY|GRYR|GRST|GRED|GRIP"><span className="mukcolon">: </span><span className="colon"> : </span></span></span>
                                    <span className="programline" id="FIELD_STUY">Health And Social Care</span><span className="jobdates" id="FIELD_GRHN"></span><span dependency="GRHN|STUY"><span dependency="GRYR|GRST|GRED|GRIP">,</span></span>
                                    <span className="jobdates" dependency="GRYR|GRST|GRED|GRIP">
                    ...
                    </div></div></div></div></div></div></div></div></div></div><div data-testid="embd-92LqKqF3" id="CONTAINER_PARENT_3" className="bottomsection"><div data-testid="embd-92PDkR65" id="CONTAINER_5" className=""></div></div></div><div></div></div></div>
    </>
  );
}
