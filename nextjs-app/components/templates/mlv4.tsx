...
export default function TemplateMlv4() {
    ...
    <>
      <style>{`
       ...
       .skn-mlv4 .lang-sec .singlecolumn,.skn-mlv4 .skli-sec .singlecolumn{display:none}
        ...
        /* .skn-mlv4.for-iron-pdf .right-box .experience .paragraph{page-break-inside: avoid!important} */
  ...
  <li>Behaviour redirection</li></ul></span>
                        ...
                        <div className="singlecolumn">
                            ...
                            <span className="disp-blk school-date" dependency="GRYR|GRST|GRED|GRIP">
                                ...
                                <span id="FIELD_GRST" format="%b %Y"></span><span id="FIELD_GRED" format="%b %Y"></span>
                                
                                <span id="FIELD_GRIP"></span>
                            </span>
                            <span className="paddedline degree" dependency="DGRE|STUY|GRPA|GRHN">
                                <span id="FIELD_DGRE">NVQ Level 3</span><span dependency="DGRE+STUY|GRHN"><span className="beforecolonspace"> </span>: </span>
                        ...
                        <div className="singlecolumn">
                            ...
                            <span className="paddedline degree" dependency="DGRE|STUY|GRPA|GRHN">
                                <span id="FIELD_DGRE">NVQ Level 2</span><span dependency="DGRE+STUY|GRHN"><span className="beforecolonspace"> </span>: </span>
                                <span id="FIELD_STUY">Health And Social Care</span>
                                <span dependency="STUY"></span><span id="FIELD_GRHN"></span>
                                <span id="FIELD_GRPA"></span>
                            </span>
                        ...
                        <svg className="top-circle" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="205px" height="127px" viewBox="0 0 205 127" version="1.1">
                            ...
                            <g id="Page-11---Final---1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" opacity="0.189506993">
                                <g className="color-svg" id="Artboard-–-65" transform="translate(-121.000000, 0.000000)" fill="#F98C79" fillRule="nonzero">
                        ...
                        <svg className="top-circle-small" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="72px" height="38px" viewBox="0 0 72 38" version="1.1">
                            ...
                            <g id="Page-11---Final---1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" opacity="0.0615025014">
                                <g className="color-svg" id="Artboard-–-65" transform="translate(-360.000000, 0.000000)" fill="#F98C79" fillRule="nonzero">
                        ...
                        <div className="singlecolumn">
                            <div className="paddedline" dependency="JTIT|COMP|JCIT|JSTA|JCNT|JCTR|JLOC|JSTD|EDDT"> 
                                ...
                                <div className="job-position">
                                    ...
                                    <span dependency="COMP"><span dependency="JCIT|JSTA|JCNT"> | </span></span><span id="FIELD_JCIT">Edinburgh</span><span id="FIELD_JSTA"></span><span id="FIELD_JCNT"></span><span dependency="COMP|JCIT|JSTA|JCNT"></span><span id="FIELD_JLOC"></span><span id="FIELD_JCTR"></span>
                                    </div>
                                   <div className="job-date"><span className="" id="FIELD_JSTD" format="%b %Y">Jul 2014</span><span dependency="JSTD+EDDT"> - </span><span id="FIELD_EDDT" format="%b %Y">Current</span></div>
                                </div>
                            </div>
                        ...
                        <div className="singlecolumn">
                            <div className="paddedline" dependency="JTIT|COMP|JCIT|JSTA|JCNT|JCTR|JLOC|JSTD|EDDT"> 
                                ...
                                <div className="job-position">
                                   ...
                                   <div className="job-date"><span className="" id="FIELD_JSTD" format="%b %Y">Sep 2010</span><span dependency="JSTD+EDDT"> - </span><span id="FIELD_EDDT" format="%b %Y">Jun 2014</span></div>
                                </div>
                            </div>
  ...
  <li>Worked to improve patient outlook and daily living through compassionate care.</li></ul></span>
                    ...
                    </div></div></div></div></div></div></div></div></div></div><div data-testid="embd-92LqKqF1" id="CONTAINER_PARENT_1" className="sign-container-parent"><div data-testid="embd-92PDkR62" id="CONTAINER_2" className="sign-container-data"></div></div></div><div></div></div></div>
    </>
  );
}
